...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    group('device is online', () {
      ...
      test(
        'should return remote data when the call to remote data souce is successful',
        () async {
          // arrange
      ...
      test(
        'should cache the data locally when the call to remote data souce is successful',
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
              .thenAnswer((_) async => tNumberTriviaModel);
      ...
      test(
        'should return server failure when the call to remote data souce is unsuccessful',
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
